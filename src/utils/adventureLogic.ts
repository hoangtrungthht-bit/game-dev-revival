...
const EVENT_TEMPLATES: ModalEventData[] = [
  ...
  },
  {
    ...
    option2: {
      ...
      failText: "Nhóm tán tu đòi giá chát, ví ngươi lighter hẳn.",
      rewards: { stones: -30 },
      penalties: { stones: -60 },
    },
  },
  ...
  },
  {
    ...
    option1: {
      ...
      rewards: { stones: 100, herbId: "linhthao", herbQty: -1 },
      penalties: { herbId: "linhthao", herbQty: -1, stones: -20 },
    },
    option2: {
      ...
      rewards: { stones: 130, herbId: "huyetchi", herbQty: 1, herbId2: undefined as never },
      penalties: { qiPct: -0.05 },
    },
  },
  {
    ...
    description:
      "Nơi đây vừa xảy ra một cơn thiên kiếp, đất nứt đá toé, tàn dư lôi điện vẫn crack chen chúc trên không. Linh thạch kiếp hâu nằm rải rác.",
    option1: {
      text: "Người lao vào nhặt linh thạch kiếp hâu",
      winRate: 0.45,
